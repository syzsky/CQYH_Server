...
{
    public class MobInfoView : RibbonForm
    {
        ...
        private void Init()
        {
            ...
            string[] names;
            names = Enum.GetNames(typeof(怪物级别分类));
            foreach (string text in names)
            {
                ...
                {
                    if (item.Value.怪物级别.ToString() == text)
                    {
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(MobInfoView));
