...
{
    public class TrapInfoView : RibbonForm
    {
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(TrapInfoView));
