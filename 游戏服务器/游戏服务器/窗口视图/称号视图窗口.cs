...
{
    public class 称号视图窗口 : RibbonForm
    {
        ...
        private void Init()
        {
            ...
            foreach (KeyValuePair<byte, 游戏称号> item in 游戏称号.数据表)
            {
                游戏称号 value;
                value = item.Value;
                this.treeList1.Nodes.Add(item.ToString()).Tag = value;
            }
        ...
        private void InitializeComponent()
        {
            ...
            treeList1.Size = new Size(350, 208);
            treeList1.TabIndex = 16;
            treeList1.RowClick += treeList1_RowClick;
            // 
            // treeListColumn1
            // 
            treeListColumn1.Caption = "游戏称号";
            treeListColumn1.FieldName = "游戏称号";
            ...
            groupControl1.Size = new Size(0, 208);
            ...
            splitterControl2.Location = new Point(1, 146);
            ...
            propertyGridControl1.Size = new Size(0, 133);
            propertyGridControl1.TabIndex = 20;
            // 
            // propertyDescriptionControl1
            // 
            propertyDescriptionControl1.Dock = DockStyle.Bottom;
            propertyDescriptionControl1.Location = new Point(1, 156);
            ...
            splitterControl3.Size = new Size(10, 208);
